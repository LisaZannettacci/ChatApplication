...
echo "   java -cp \"$CP\" server.ChatServer 6090"
echo ""
echo "2. Lancer le client (Mode TEXTE) :"
echo "   java -cp \"$CP\" client.ChatClient localhost 6090 Lisa 0"
echo ""
echo "3. Lancer le client (Mode GRAPHIQUE) :"
echo "   java -cp \"$CP\" client.ChatClient localhost 6090 Lisa 0 --gui"
echo "--------------------------------------------------"